        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="mb-2 flex items-center gap-3">
            ...
            <h1 className="text-xl font-semibold leading-snug text-gray-900">
              {threeStrikesWedgeConfig.testName}
            </h1>
          </div>
          <p className="mt-2 text-sm leading-relaxed text-gray-600">
            Random wedge targets with a strict ±3.0 m scoring window. Build hits until you collect
            three strikes.
          </p>

          <ThreeStrikesWedgeRunner />
          <CombineCommunityHighlights definition={combineHighlightThreeStrikes} />
        </div>
      </div>
    </div>
  );
